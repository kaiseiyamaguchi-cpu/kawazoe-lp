    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <article className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <p>
            ※表示価格は全て税込価格です。<br />
            ※Apple App Store、Google Play Storeでのお支払いの場合、各ストアの価格体系に準じます。最新の正確な価格は、アプリ内の購入画面をご確認ください。
          </p>
          ...
          <p>
            ...
            <strong>初回決済</strong>：無料トライアル期間終了後に初回決済が行われます。
          </p>
          ...
          <h2>無料トライアルについて</h2>
          <p>初回お申し込みに限り、<strong>1ヶ月間の無料トライアル期間</strong>がございます。</p>
          <ul>
            <li>トライアル期間中は、プレミアムプランの全機能を無料でご利用いただけます。</li>
            <li>トライアル期間終了の<strong>24時間前までに解約手続きを行わない場合</strong>、自動的に有料プランへ移行し、課金が開始されます。</li>
            <li>無料トライアルは、お一人様1回限りとなります。</li>
            <li>過去にプレミアムプランをご契約されたことがある方は、無料トライアルの対象外となります。</li>
          </ul>
          ...
          <p>
            ...
            <strong>最終更新日：2025年12月26日</strong>
          </p>
        </article>
      </div>
